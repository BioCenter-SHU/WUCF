...
class devide_1(nn.Module):
    def __init__(self, block_num, num_classes=100,pretrained=None):
        ...
        self.stage1 = self._make_stage(64, 256, block_num, AttentionModule1)
...
class devide_2(nn.Module):
    def __init__(self, block_num, num_classes=100,pretrained=None):
        super().__init__()
        self.stage2 = self._make_stage(256, 512, block_num, AttentionModule2)
    def forward(self, x):
        x = self.stage2(x)
        return x
    def _make_stage(self, in_channels, out_channels, num, block):
...
class devide_3(nn.Module):
    def __init__(self, block_num, num_classes=100,pretrained=None):
        super().__init__()
        self.stage3 = self._make_stage(512, 1024, block_num, AttentionModule3)
...
class Feature(nn.Module):
    ...
    Args:
        block_num: attention module number for each stage
    """
     def __init__(self, block_num = [1, 1, 1], num_classes=2,pretrained=None):
